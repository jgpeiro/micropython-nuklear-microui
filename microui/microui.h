...
#define MU_ROOTLIST_SIZE        (32/1)
#define MU_CONTAINERSTACK_SIZE  (32/1)
#define MU_CLIPSTACK_SIZE       (32/1)
#define MU_IDSTACK_SIZE         (32/1)
#define MU_LAYOUTSTACK_SIZE     (16/1)
#define MU_CONTAINERPOOL_SIZE   (48/1)
#define MU_TREENODEPOOL_SIZE    (48/1)
#define MU_MAX_WIDTHS           (16/1)
#define MU_REAL                 float
#define MU_REAL_FMT             "%.3g"
#define MU_SLIDER_FMT           "%.2f"
#define MU_MAX_FMT              (127/1)
...
typedef struct { mu_BaseCommand base; mu_Rect rect; mu_Color color; } mu_BoxCommand;
...
#define mu_slider(ctx, label, value, lo, hi)     mu_slider_ex(ctx, label, value, lo, hi, 0, MU_SLIDER_FMT, MU_OPT_ALIGNCENTER)
...
int mu_slider_ex(mu_Context *ctx, const char *label, mu_Real *value, mu_Real low, mu_Real high, mu_Real step, const char *fmt, int opt);
